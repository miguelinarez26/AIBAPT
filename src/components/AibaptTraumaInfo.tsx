      ...
      <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        <div className="w-full lg:w-1/2 relative">
           ...
           <div className="absolute -bottom-8 -right-4 sm:-right-8 bg-white p-6 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] max-w-[280px] z-10">
              ...
              <h4 className="text-primary font-bold text-lg mb-2">Existe tratamiento efectivo</h4>
              <p className="text-text-dark text-sm leading-relaxed">A través de enfoques integradores es posible restaurar el bienestar integral.</p>
           </div>
        </div>

        {/* Right Side: Text */}
        <div className="w-full lg:w-1/2 mt-10 lg:mt-0">
          <p className="text-accent text-[13px] font-semibold tracking-[0.2em] uppercase mb-4">Comprendiendo la Raíz</p>
          <h2 className="text-4xl md:text-[56px] font-serif text-text-light leading-[1.1] mb-8">
            ¿Qué es el <span className="italic font-light text-primary">Trauma</span> Psicológico o Emocional?
          </h2>
          <p className="text-text-dark text-lg leading-relaxed mb-10">
            El trauma psicológico es el resultado de un evento o serie de eventos abrumadores que exceden nuestra capacidad de afrontamiento. No se trata simplemente del evento en sí, sino de la <strong className="text-text-light">respuesta de nuestro sistema nervioso</strong> que queda atrapada en un estado de alerta constante o disociación.
          </p>
          ...
          <div className="bg-white p-8 md:p-10 rounded-2xl border-l-4 border-accent shadow-sm relative">
             ...
             <p className="mt-6 text-accent font-semibold tracking-wider uppercase text-sm">— Dr. Gabor Maté</p>
          </div>
        </div>
      </div>
    </section>
