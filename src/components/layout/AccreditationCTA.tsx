...
export const AccreditationCTA = () => {
    return (
        <section className="py-10 lg:py-12 bg-white dark:bg-[#0a0f0d] relative overflow-hidden transition-colors duration-500">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-gray-100 dark:border-white/10 rounded-[3rem] p-8 md:p-10 lg:p-12 shadow-[0_30px_100px_-20px_rgba(0,0,0,0.08)] dark:shadow-2xl overflow-hidden relative group">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-5">
                                <Button 
                                    variant="primary" 
                                    size="lg" 
                                    className="rounded-2xl px-12 font-bold shadow-xl group border-none"
                                    onClick={() => {}} // Placeholder as requested
                                >
                                    SOLICITAR ACREDITACIÓN
                                    <FiFileText className="ml-2 group-hover:rotate-12 transition-transform" />
                                </Button>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="relative w-full h-full flex items-center justify-center lg:-ml-6 lg:-mr-10">
                                <div className="absolute inset-0 bg-primary/5 dark:bg-primary/20 rounded-full blur-[80px] pointer-events-none" />
                                
                                <div className="relative w-full h-[250px] lg:w-[350px] lg:h-[350px] flex items-center justify-center z-10 group-hover:scale-105 transition-transform duration-700">
