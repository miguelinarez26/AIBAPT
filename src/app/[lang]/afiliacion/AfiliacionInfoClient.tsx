...
export default function AfiliacionInfoClient() {
    const { t } = useLanguage();
    ...
    return (
        <section className="py-20 overflow-hidden relative bg-cream dark:bg-bg-dark">
            {/* Ambient Backgrounds */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-5xl font-extrabold text-text-main dark:text-white mb-6 leading-tight font-display">
                        ...
                        >
                            ...
                            {activeTab === "pleno" && (
                                <div>
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-bold text-text-main dark:text-white">{t("member.pleno.title" as any)}</h3>
                                    ...
                                    <div className="bg-accent/10 dark:bg-gray-800/50 p-6 rounded-2xl mb-8">
                                        <h4 className="font-bold text-text-main dark:text-white mb-4">{t("member.pleno.reqs" as any)}</h4>
                                    ...
                                    <h4 className="text-xl font-bold text-text-main dark:text-white mb-6 text-center">{t("member.steps.title" as any)}</h4>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                                        {steps.map((step, index) => (
                                            <div key={index} className="relative flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-text-main dark:text-white text-sm mb-2">{step.title}</h5>
                            ...
                            {activeTab === "otros" && (
                                <div className="text-center py-10">
                                    ...
                                    <h3 className="text-2xl font-bold text-text-main dark:text-white mb-4">{t("member.otros.title" as any)}</h3>
                            ...
                            {activeTab === "cert" && (
                                <div className="text-center py-10">
                                    ...
                                    <h3 className="text-2xl font-bold text-text-main dark:text-white mb-4">{t("member.cert.title" as any)}</h3>
                            ...
                            {activeTab === "inst" && (
                                <div>
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-bold text-text-main dark:text-white">{t("member.inst.title" as any)}</h3>
