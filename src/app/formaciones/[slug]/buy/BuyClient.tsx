...
export default function BuyClient({ slug }: { slug: string }) {
    ...
    if (!course) {
        return (
            <div className="pt-32 pb-20 min-h-screen flex items-center justify-center bg-background-light dark:bg-bg-dark">
    ...
    return (
        <div className="pt-24 pb-20 min-h-screen bg-background-light dark:bg-bg-dark font-sans relative">
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        <motion.section
                            ...
                            className="bg-white/80 backdrop-blur-md dark:bg-surface-dark border border-white/60 dark:border-gray-800 rounded-[32px] p-6 md:p-8 shadow-sm"
                        >
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <input type="text" placeholder="Nombre completo" className="w-full bg-white/60 dark:bg-surface-light border border-white/60 dark:border-gray-700 rounded-xl px-4 py-3 text-text-main dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:bg-white transition-all" />
                                    <input type="text" placeholder="Teléfono (Opcional)" className="w-full bg-white/60 dark:bg-surface-light border border-white/60 dark:border-gray-700 rounded-xl px-4 py-3 text-text-main dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:bg-white transition-all" />
                                </div>
                                <input type="email" placeholder="Correo electrónico" className="w-full bg-white/60 dark:bg-surface-light border border-white/60 dark:border-gray-700 rounded-xl px-4 py-3 text-text-main dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:bg-white transition-all" />
                            </div>
                        </motion.section>
                        ...
                        <motion.section
                            ...
                            className="bg-white/80 backdrop-blur-md dark:bg-surface-dark border border-white/60 dark:border-gray-800 rounded-[32px] p-6 md:p-8 shadow-sm relative overflow-hidden"
                        >
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-xl font-bold text-text-main dark:text-white flex items-center gap-2">
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <input type="text" placeholder="País / Región" className="w-full bg-white/60 dark:bg-surface-light border border-white/60 dark:border-gray-700 rounded-xl px-4 py-3 text-text-main dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:bg-white transition-all" />
                                    <div className="relative">
                                        <input type="text" placeholder="Código Postal" className="w-full bg-white/60 dark:bg-surface-light border border-white/60 dark:border-gray-700 rounded-xl px-4 py-3 text-text-main dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50 focus:bg-white transition-all" />
                                    </div>
                                </div>
                    ...
                    <aside className="w-full lg:w-[420px] shrink-0 text-text-main dark:text-white">
                        <div className="bg-white/80 backdrop-blur-md dark:bg-surface-dark border border-white/60 dark:border-gray-800 rounded-[32px] overflow-hidden shadow-xl sticky top-28">
                            ...
                            <div className="p-6">
                                ...
                                <button className={`w-full text-white font-bold inline-flex items-center justify-center gap-3 py-4 rounded-full shadow-md transition-all hover:-translate-y-1 group ${paymentMethod === 'paypal' ? 'bg-[#0070ba] hover:bg-[#003087]' : 'bg-primary hover:bg-primary/90'
                                    }`}>
