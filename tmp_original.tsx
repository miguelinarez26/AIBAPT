    ...
    const webinarsData = useMemo(() => [
        {
            ...
            instructorImg: "", instructorName: "Susana D├¡az", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Daniel Gabarra", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Sebasti├ín Segui", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Renata Teles", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Norma Contreras", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Sandra Fiore", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Juan Alexis", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Angela Maranho", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: "", instructorName: "Paulina Gonz├ílez Aguilar", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "1 Cr├®dito AIBAPT"
        },
        {
            img: logoAibapt,
            ...
            instructorImg: logoAibapt, instructorName: "AIBAPT", route: "/formaciones", price: "Inscripci├│n", isOfficial: true, duration: "Participaci├│n Socios"
        }
    ], []);
    ...
    const eventsData = useMemo(() => [
        {
            ...
            price: "Ir a la inscripci├│n", isOfficial: false, duration: ""
        },
        {
            img: imgBS,
            badge: "Online", badgeIcon: "event", badgeStyle: "text-primary",
                    ...
                    >
                        {(activeTab === "events" || activeTab === "recordings") && (
                            <div className="flex-1">
                                {/* Filtros de B├║squeda - Variante Socios */}
                        ...
                        {/* Accredited and Accreditation views */}
                            ...
                            <div className="w-full md:w-7/12 p-8 md:p-12 overflow-y-auto flex flex-col">
                                <div className="mb-8 flex-1">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-2">
                                        ...
                                        <div className="bg-gray-50 p-5 rounded-2xl border border-gray-100 flex flex-col gap-1">
                                            <span className="text-[10px] font-bold text-text-muted uppercase tracking-wider">Duraci├│n / Valor</span>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        ...
                                        <button className="flex items-center justify-between p-4 bg-primary text-white rounded-2xl hover:bg-primary-dark transition-all shadow-md hover:-translate-y-0.5 group">
                                            <div className="flex flex-col items-start gap-0.5">
                                                ...
                                                <span className="text-sm font-semibold">Cr├®dito Prepago</span>
                                            </div>
