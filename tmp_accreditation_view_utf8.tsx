    ...
    const eventsData = [
        {
            ...
            desc: "Curso vivencial com demonstrações ao vivo e práticas supervisionadas, focado no manejo do corpo no atendimento online. Inicia 8 de mayo de 2026.",
            instructorImg: "",
        ...
        },
        {
            ...
            title: "Treinamento Básico em Brainspotting – online (Fases 1 e 2)",
            desc: "Teoria, demonstração ao vivo e práticas supervisionadas. Certificação internacional de Brainspotting Inc. EUA e AIBAPT.",
            instructorImg: "",
        ...
        },
        {
            img: imgTDAH,
            badge: "Online", badgeIcon: "event", badgeStyle: "text-primary",
            category: "Formación EMDR | Brasil",
            title: "Destravando o TDAH com EMDR e Autorregulação",
            desc: "Uma leitura humana e neurocientífica do TDAH articulada com EMDR e autorregulação, programado para el 20 de junio de 2026.",
            instructorImg: "",
        ...
        {
            img: imgCongreso,
            badge: "Híbrido", badgeIcon: "event", badgeStyle: "text-primary",
            category: "Congreso",
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-8">
                                        ...
                                        <div className="bg-accent/5 dark:bg-accent/10 p-4 rounded-2xl border border-accent/10">
                                            <span className="text-[10px] font-bold text-text-muted dark:text-gray-500 uppercase block mb-1">Duración / Valor</span>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        ...
                                        <button className="flex items-center justify-between p-4 bg-primary text-white rounded-2xl hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 group">
                                            <div className="flex flex-col items-start">
                                                ...
                                                <span className="text-sm font-bold">Crédito Prepago</span>
                                            </div>
